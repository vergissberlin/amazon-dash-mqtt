...
buttonChuckNorris.addListener(async () => {
  ...
  request(jokeRequest, function(error, response) {
    if (!error && (response.statusCode === 200)) {
      ...
      sendToSlack(joke, 'Chuck Norris', 'https://pm1.narvii.com/6037/494011a5f5cbdc6fe7f515a3b8f2c464c6c5f5e5_128.jpg', null, '@random')
    } else {
      return false;
...
buttonBlugento.addListener(async () => {
    sendToSlack('New release is out!', 'Blugento', 'https://s3.amazonaws.com/f6s-public/profiles/1384760_original.jpg', null, '@umg')
})
